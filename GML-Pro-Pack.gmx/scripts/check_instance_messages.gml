...
if ( global.instance_messages_send ) {//
 var i,
  new,new_r,new_u,new_n,new_t,new_d,new_delay,store;
 new=0;
 new_r[0]=noone;
 new_u[0]=noone;
 new_n[0]=0;
 ...
 for ( i=0; i<global.instance_messages_pending; i++ ) {
  ...
  if ( store ) { // Store in the still pending list
   new_r[new]=global.instance_message_room[i];
   new_u[new]=global.instance_message_uid[i];
   new_n[new]=global.instance_message_number[i];
   new_t[new]=global.instance_message_type[i];
   new_d[new]=global.instance_message_data[i];
   new_delay[new]=global.instance_message_delay[i];
   new+=1;
  }
 }
 ...
 global.instance_messages_pending=new;
}//
