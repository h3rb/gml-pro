...
//######################_==_YOYO_SHADER_MARKER_==_######################@~varying vec4 v_vColour;    // final color to multiply by
varying vec2 v_vTexcoord;
...
uniform sampler2D tex4; // A value
void main() {
 ...
 vec4 fa=texture2D(tex4,v_vTexcoord);
 vec4 stenciled;
 stenciled= fr*f0.r +fg*f0.g +fb*f0.b +fa*f0.a;
