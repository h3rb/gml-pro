...
//NoiseTex (sampler2D): noise texture.
//PixelX (float): effect param, default value: 2.0
//PixelY (float): effect param, default value: 2.0
//Freq (float): effect param, default value: 0.0115
